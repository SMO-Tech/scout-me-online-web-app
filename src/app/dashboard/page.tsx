...
const Page = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center bg-black sm:p-10">
      <h1 className="text-white mt-5 text-3xl sm:text-4xl font-extrabold mb-6 text-center">
        Let&apos;s get your first game analysed <br />
      ...
      <button
        ...
        className="px-8 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-full shadow-lg transition-all duration-300"
      >
        Let&apos;s Analyse
      </button>
    </div>
