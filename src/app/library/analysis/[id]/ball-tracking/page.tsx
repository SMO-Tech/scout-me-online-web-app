...
import { getBallTracking, BallTrackingResponse, BallTrackingPoint } from '@/services/api/matchAnalysis.service'
...
export default function BallTrackingPage() {
  ...
  // Auto-play animation
  useEffect(() => {
    if (isPlaying && ballTrackingData && currentFrame < ballTrackingData.data.tracking_data.length - 1) {
