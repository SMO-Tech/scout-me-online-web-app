...
import { PlayerTrackingResponse, PlayerTrackingData, PlayerTrackingPoint, getPlayerTracking } from '@/services/api/matchAnalysis.service'

interface ClientPlayerTrackingPageProps {
  initialData: PlayerTrackingResponse | null;
  jobId: string;
}

export default function ClientPlayerTrackingPage({ initialData, jobId }: ClientPlayerTrackingPageProps) {
  const router = useRouter()
  const [playerTrackingData, setPlayerTrackingData] = useState<PlayerTrackingResponse | null>(initialData)
